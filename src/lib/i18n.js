...
export const messages = {
  ko: {
    ...
    'app.optionsTitle': 'Refont 설정',
    'app.popupTitle': 'Refont',
  },
  en: {
    ...
    'lang.ko': '한국어',
    'lang.en': 'English',
    'picker.search': 'Search or type…',
    'picker.recent': 'Recent',
    'picker.all': 'All',
    'picker.custom': 'Custom',
    'picker.customBadge': 'custom',
    'picker.useCustom': 'Use custom: "{name}"',
    'picker.empty': 'No results — type to set a custom family',
    'app.optionsTitle': 'Refont Settings',
    'app.popupTitle': 'Refont',
  },
};
